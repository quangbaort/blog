                ...
                <div class="card-body">
                    <form action="{{ route('admin.addArticle') }}"  method="POST">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" value="{{ old('avatar')}}"readonly class="form-control" id="avatar" name="avatar" placeholder="file" aria-label="file" aria-describedby="basic-addon1">
                        ...
                        <textarea name="article_text"  id="article_text" cols="30" rows="10">{{ old('article_text') }}</textarea>
                        @error('article_text')
                            <span class="help-block text-danger">{{ __($message) }}</span>
                        @enderror
                        <div class="form-group">
